...
if not GEMINI_API_KEY.startswith("AIza"):
    st.error("⚠️ **Chave do Gemini Inválida!** A chave de API do Google AI Studio precisa começar com `AIzaSy...`. Gere em [aistudio.google.com/app/apikey](https://aistudio.google.com/app/apikey).")
    st.stop()
